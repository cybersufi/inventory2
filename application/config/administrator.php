<?php  if (!defined('BASEPATH')) exit('No direct script access allowed');
	...
	$config['administrator']['usermanager']['content_file']['userlist'] = 'administrator/user/user_list';


	$config['administrator']['permmanager']['page_title'] = "Permission Manager";
	$config['administrator']['permmanager']['content_file']['permlist'] = 'administrator/permission/perm_list';
